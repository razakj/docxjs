...
const paragraph_1 = __importDefault(require("./parts/paragraph"));
...
>
    ...
    ${Array.isArray(headerOrFooter.hf.paragraphs) ? headerOrFooter.hf.paragraphs.map(p => paragraph_1.default(p, headerOrFooter.imageIndex, headerOrFooter.sourceName)) : ''}
